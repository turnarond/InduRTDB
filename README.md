...
| 文档 | 位置 | 版本 |
|------|------|------|
| 需求规格说明书 (SRS) | `docs/需求文档/` | v1.0 |
| 编码规范 | `docs/需求文档/编码规范.md` | v1.0 |
| 概要设计 (HLD) | `docs/设计文档/` | v1.1.0 |
| 工程框架架构设计 | `docs/设计文档/` | v1.1.0 |
| 详细设计 (LLD) | `docs/设计文档/` | v2.0.0 |
| Seqlock 算法设计 | `docs/技术文档/` | v2.0.0 |
| 项目开发总结 | `docs/开发规划/` | v2.0.0 |
| 变更日志 | `CHANGELOG.md` | — |
